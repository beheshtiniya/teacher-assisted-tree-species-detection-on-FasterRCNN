...
def parse_args():
    ...
    p.add_argument('--num-runs',type=int,default=5); p.add_argument('--max-epochs',type=int,default=20); p.add_argument('--batch-size',type=int,default=4); p.add_argument('--workers',type=int,default=0); p.add_argument('--base-seed',type=int,default=42); p.add_argument('--patience',type=int,default=5); p.add_argument('--min-delta',type=float,default=1e-4); p.add_argument('--lr',type=float,default=0.005); p.add_argument('--weight-decay',type=float,default=0.0005); p.add_argument('--iou-threshold',type=float,default=0.5); p.add_argument('--score-threshold',type=float,default=0.25)
    return p.parse_args()
