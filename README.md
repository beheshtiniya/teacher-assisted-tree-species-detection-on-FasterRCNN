...
# توضیحات فارسی برای کاربران

این مخزن شامل کدها، فایل‌های تنظیمات و پایپ‌لاین بازتولیدپذیر پروژه تشخیص گونه
درختان در جنگل‌های ناهمگن با استفاده از تصاویر RGB هوایی است.

دیتاست تصاویر و برچسب‌های کارشناسی داخل بسته نرم‌افزار قرار ندارد. کاربران
باید دیتاست را به‌صورت جداگانه از رکورد Zenodo زیر دریافت کنند:

**Dataset for Tree Species Detection in Heterogeneous Forests Using Aerial RGB Imagery**

**DOI:** https://doi.org/10.5281/zenodo.21385214

پس از دانلود دیتاست، مسیر پوشه داده و Python باید با فایل
`configure_paths.cmd` تنظیم شود. فایل محلی ایجادشده در
`config/paths.local.json` فقط مخصوص سیستم کاربر است و نباید در GitHub یا
بسته نرم‌افزاری Zenodo قرار گیرد.

پایپ‌لاین به مراحل شماره‌گذاری‌شده تقسیم شده است و هر مرحله را می‌توان به‌صورت
مستقل اجرا و بررسی کرد. پیش از شروع آموزش‌های سنگین، ساختار پوشه‌ها، مسیرها،
وابستگی‌ها و ورودی‌های هر مرحله باید کنترل شوند.
